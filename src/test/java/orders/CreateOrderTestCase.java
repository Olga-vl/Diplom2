...
public class CreateOrderTestCase {
    ...
    public void checkOrderCreateWithIngredientsWithAuthorization() {
    ...
    public void checkOrderCreateWithoutAuthorization() {
    ...
    public void checkCreationOrderWithoutIngredients() {
        ...
        assertEquals(
                "Невалидные данные в ответе: message",
    ...
    public void checkOrderCreatedWithInvalidIngredientHash() {

        String accessToken = login();
        Response response = order.createOrder(singletonList("InvalidIngredientHash"), accessToken);
